    ...
    <nav>
        <ul class="menu">
            ...
            <div class="icons" <?php if ($isAdmin): ?> id="icons-admin" <?php endif; ?>>
                <?php if ($isAdmin): ?>
                    <li class="home icon"><a href="./managePage.php"><i class='bx bx-home'></i></a></li><?php endif; ?>
            ...
            <div class="userItem userBreak ">
                ...
                <?php endif; ?>
                <li class="userItem">Your account</li>
                <li class="userItem">Orders</li>
                <li class="userItem">Reviews</li>
                <li class="userItem wishlist"><a href="./wishlists.php"><i
                                class='bx bx-heart'><span>Wishlists</span></i></a></li>
                <?php if ($isLogged): ?>
                    <li class="userItem signup"><a href="./settings.php">Account settings</a></li>
                <?php endif; ?>
                <?php if ($isLogged): ?>
